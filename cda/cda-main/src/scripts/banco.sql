-- ==========================================================
-- SCRIPT DE CRIAÇÃO DO BANCO DE DADOS - PLATAFORMA CDA 2026
-- Versão: 2.1 (MVP Atualizado)
-- ==========================================================
...
-- 3. USUARIO (Ajustado: senha_hash -> senha)
...
-- 6. CICLO_COLABORADOR (Tabela de Junção Central)
...
CREATE TABLE IF NOT EXISTS public.avaliacao (
    ...
    status character varying NOT NULL, -- 'PENDENTE', 'EM_ANDAMENTO', 'FINALIZADO'
...
CREATE TABLE IF NOT EXISTS public.colaborador_trilha (
    ...
    CONSTRAINT colaborador_trilha_colaborador_id_fkey FOREIGN KEY (colaborador_id) REFERENCES public